...
class Monkey {
    ...
    public:
        ...
        void do_worry_level_calculations() {
            std::for_each(
                worry_levels.begin(),
                worry_levels.end(),
...
int main() {
    ...
    for (int i=0; i<num_of_rounds; i++) {
        ...
        for (auto &monkey: monkeys) {
            monkey.do_worry_level_calculations();
    ...
    long product_of_top_two_monkeys = (
        monkeys.at(0).num_of_items_inspected *
        monkeys.at(1).num_of_items_inspected
    );
