...
size_t ordered_page_numbers_get_true_size(long* const ordered_page_numbers, size_t size);
int line_to_number_list(long* num_list, size_t num_list_size, const char* const line);
...
int line_to_number_list(long* num_list, size_t num_list_size, const char* const line) {
    ...
    char* const string_list = malloc(sizeof(char) * string_list_size * string_list_elem_len);
...
int main(void) {
    ...
    while (true) {
        ...
        const int page_update_list_elems = line_to_number_list(
            page_update_list,
